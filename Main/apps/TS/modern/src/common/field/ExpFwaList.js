 ...
 */
Ext.define('TS.common.field.ExpFwaList', {
    extend: 'Ext.field.Select',

    requires: [
        'TS.common.picker.ExpFwaTwoLinePicker',
        'TS.store.ExpFwaList'
    ],
    ...
    getPhonePicker: function () {
        ...
        if (!phonePicker) {
            ...
            me.phonePicker = phonePicker = Ext.create('TS.common.picker.ExpFwaTwoLinePicker', Ext.apply({
                slots: [{
                    align: 'left',
                    name: me.getName(),
