...
Ext.app.REMOTING_API = {
    ...
    "actions": {
        ...
        "Exp": [{
            ...
            "name": "SubmitExpReport", //string dbi, string username, ExpenseReport expReport, Attachment signature
            "len": 4
        }, {
        ...
        "Employee": [{
            ...
            "name": "GetEmployeeSkillSetList",
            "len" : 1
        },{
            "name": "GetEmployeeRegistrationList",
            "len" : 1
        }],
        ...
        "UserConfig": [{
            ...
            "name": "GetUserDefinedFieldList", //string dbi, string username
            "len": 2
        }],
        "PriorityList": [{
        ...
        "Fwa": [{
            ...
            "name": "GetSchedulerFwaList", //string dbi,  string username, int start, int limit,string empId, bool isPreparedByMe,int timeZoneOffset, bool scheduledFwas
            "len": 8
        }, {
            ...
            "name": "RemoveFwaStatus", //string dbi, string username, string employeeId, string fwaId
            "len": 4,
            "formHandler": false
        }, {
            ...
            "name": "GetFwaDropdownValuesByWbs",//string dbi, string username, string fwaId, string wbs1, string wbs2, string wbs3
            "len": 6
        }],
        "FwaStatus": [{
            "name": "GetList", //string dbi, string username, int start, int limit
