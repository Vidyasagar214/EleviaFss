/**
 * This class is the view model for the Timesheet Viewport
 */
Ext.define('TS.model.ts.MainModel', {
    extend: 'TS.view.main.MainModel',

    alias: 'viewmodel.timesheet',
    ...
    formulas: {
        ...
        isTsApprover: function (get) {
            return TS.app.settings.tsIsApprover;
        },

        isHidden: function (get) {
            return !TS.app.settings.tsCanViewCrewMemberTime; //get('hideColumn')
        },
