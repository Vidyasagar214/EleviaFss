 ...
 */
Ext.define('TS.controller.exp.ExpSubmitPinController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.expsubmitpin',
    config: {
        sprite: null
    },
    ...
    expSubmitPinClick: function () {
        ...
        //             me.doSaveSignature();
        //         } else {
        //             Ext.GlobalEvents.fireEvent('Message:Code', 'expSubmitPinBadField');
    ...
    doSaveSignature: function () {
        ...
        var me = this,
            ...
            data = {
                ...
                description: 'Expense Report Submit Signature',
                file: file
            };
        ...
        me.convertFileToByteData(data.file, Ext.bind(function (byteData) {
            ...
            Ext.GlobalEvents.fireEvent('SubmitExpAfterPinCheck', view.button, view.event, attachmentRecord);
