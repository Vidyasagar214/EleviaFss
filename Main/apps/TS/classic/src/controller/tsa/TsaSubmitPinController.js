 ...
 */
Ext.define('TS.controller.tsa.TsaSubmitPinController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.window-tsasubmitpin',
    ...
    tsSubmitPinClick: function () {
        ...
        //     return;
        // }
        me.doSaveSignature(view.flag, view.attachmentsList.tsPeriodId);
        // if (form.isValid()) {
    ...
    doSaveSignature: function (flag, tsPeriodId) {
        ...
        me.convertFileToByteData(data.file, Ext.bind(function (byteData) {
            ...
            Ext.GlobalEvents.fireEvent('ApproveRejectTsAfterPinCheck', view.config.grid, view.config.record, tsPeriodId, flag, attachmentRecord);// view.button, view.event, attachmentRecord);
            me.getView().close();
